...
class QuestionFavoritesRecord extends FirestoreRecord {
  QuestionFavoritesRecord._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('question_favorites');

  static Stream<QuestionFavoritesRecord> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => QuestionFavoritesRecord.fromSnapshot(s));

  static Future<QuestionFavoritesRecord> getDocumentOnce(
          DocumentReference ref) =>
      ref.get().then((s) => QuestionFavoritesRecord.fromSnapshot(s));

  static QuestionFavoritesRecord fromSnapshot(DocumentSnapshot snapshot) =>
      QuestionFavoritesRecord._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static QuestionFavoritesRecord getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      QuestionFavoritesRecord._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'QuestionFavoritesRecord(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is QuestionFavoritesRecord &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQuestionFavoritesRecordData({
...
class QuestionFavoritesRecordDocumentEquality
    implements Equality<QuestionFavoritesRecord> {
  const QuestionFavoritesRecordDocumentEquality();

  @override
  bool equals(QuestionFavoritesRecord? e1, QuestionFavoritesRecord? e2) {
  ...
  @override
  int hash(QuestionFavoritesRecord? e) => const ListEquality().hash([
  ...
  @override
  bool isValidKey(Object? o) => o is QuestionFavoritesRecord;
}
