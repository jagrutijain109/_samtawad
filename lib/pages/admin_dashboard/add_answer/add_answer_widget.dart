...
class AddAnswerWidget extends StatefulWidget {
  ...
  static String routeName = 'add_answer';
  static String routePath = '/addAnswer';
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '9lwuugxm' /* Add  Vachan-Description */,
                        ),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await AnswerRecord.createDoc(widget!.questionref!).set({
                          ...createAnswerRecordData(
                            answerId: '',
                            vachan: _model.questionNumberTextController.text,
                            description: _model.questionTextController.text,
                          ),
                          ...mapToFirestore(
                            {
                        ...
                        FFAppState().descriptionList =
                            (List<String> var1, String var2) {
                          return var1 + [var2];
                        }(FFAppState().descriptionList.toList(),
                                    _model.questionTextController.text)
                                .toList()
                                .cast<String>();
                        safeSetState(() {});
                        FFAppState().guruvacnList =
                            (List<String> var1, String var2) {
                          return var1 + [var2];
                        }(FFAppState().guruvacnList.toList(),
                                    _model.questionNumberTextController.text)
                                .toList()
                                .cast<String>();
                        safeSetState(() {});
                        safeSetState(() {
                          _model.questionNumberTextController?.clear();
                          _model.questionTextController?.clear();
                        });
                      },
                      text: FFLocalizations.of(context).getText(
                        'fnmk6w64' /* Add Question-Answer */,
                      ),
