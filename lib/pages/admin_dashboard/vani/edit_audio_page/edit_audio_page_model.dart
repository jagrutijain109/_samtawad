...
import 'dart:ui';
import '/index.dart';
import 'edit_audio_page_widget.dart' show EditAudioPageWidget;
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class EditAudioPageModel extends FlutterFlowModel<EditAudioPageWidget> {
  ...
  // State field(s) for satsang_tilte widget.
  FocusNode? satsangTilteFocusNode;
  TextEditingController? satsangTilteTextController;
  String? Function(BuildContext, String?)? satsangTilteTextControllerValidator;
  ...
  bool isDataUploading_uploadEditVaniLyrics = false;
  List<FFUploadedFile> uploadedLocalFiles_uploadEditVaniLyrics = [];
  List<String> uploadedFileUrls_uploadEditVaniLyrics = [];
  ...
  bool isDataUploading_editVaniImage = false;
  FFUploadedFile uploadedLocalFile_editVaniImage =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_editVaniImage = '';
  ...
  @override
  void dispose() {
    satsangTilteFocusNode?.dispose();
    satsangTilteTextController?.dispose();
