...
import 'add_online_satsang_model.dart';
export 'add_online_satsang_model.dart';

class AddOnlineSatsangWidget extends StatefulWidget {
  const AddOnlineSatsangWidget({super.key});

  static String routeName = 'add_online_satsang';
  static String routePath = '/addOnlineSatsang';

  @override
  State<AddOnlineSatsangWidget> createState() => _AddOnlineSatsangWidgetState();
}

class _AddOnlineSatsangWidgetState extends State<AddOnlineSatsangWidget> {
  late AddOnlineSatsangModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddOnlineSatsangModel());
    ...
    _model.linkSatsangTextController ??= TextEditingController();
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'vkxnl5l4' /* Enter Contact Information */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await OnlineSatsangDataRecord.collection
                                          .doc()
                                          .set(
                                              createOnlineSatsangDataRecordData(
                                            link: _model
                                                .linkSatsangTextController.text,
                                            fromDate: _model.datePicked2,
                                            toDate: _model.datePicked4,
                                            satsangName: _model
                                    ...
                                    text: FFLocalizations.of(context).getText(
                                      '498ar1y9' /* Add Online Satesang Details */,
                                    ),
