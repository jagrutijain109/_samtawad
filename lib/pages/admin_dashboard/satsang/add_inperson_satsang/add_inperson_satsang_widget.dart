...
import 'add_inperson_satsang_model.dart';
export 'add_inperson_satsang_model.dart';

class AddInpersonSatsangWidget extends StatefulWidget {
  const AddInpersonSatsangWidget({super.key});

  static String routeName = 'add_inperson_satsang';
  static String routePath = '/addInpersonSatsang';

  @override
  State<AddInpersonSatsangWidget> createState() =>
      _AddInpersonSatsangWidgetState();
}

class _AddInpersonSatsangWidgetState extends State<AddInpersonSatsangWidget> {
  late AddInpersonSatsangModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddInpersonSatsangModel());
    ...
    _model.satsangNoteTextController ??= TextEditingController();
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'alpmskgw' /* Enter Contact Information */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.satsangAddressFocusNode,
                                    autofocus: false,
                                    textInputAction: TextInputAction.next,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '35qcs5nt' /* Enter Aashram  Address */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await InpersonSatsangRecord.collection
                                          .doc()
                                          .set({
                                      ...
                                      context.pushNamed(
                                          InpersonSatsangPageWidget.routeName);
                                    },
                                    text: FFLocalizations.of(context).getText(
                                      '5w9v8a1w' /* Add Inperson Satesang Details */,
                                    ),
