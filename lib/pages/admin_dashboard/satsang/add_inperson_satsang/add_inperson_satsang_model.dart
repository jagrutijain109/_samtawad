...
import 'dart:ui';
import '/index.dart';
import 'add_inperson_satsang_widget.dart' show AddInpersonSatsangWidget;
...
class AddInpersonSatsangModel
    extends FlutterFlowModel<AddInpersonSatsangWidget> {
  ...
  String? _satsangNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ytyhoxx3' /* TextField is required */,
      );
    }
