...
import 'satsang_category_popup_model.dart';
export 'satsang_category_popup_model.dart';

class SatsangCategoryPopupWidget extends StatefulWidget {
  const SatsangCategoryPopupWidget({super.key});

  @override
  State<SatsangCategoryPopupWidget> createState() =>
      _SatsangCategoryPopupWidgetState();
}

class _SatsangCategoryPopupWidgetState
    extends State<SatsangCategoryPopupWidget> {
  late SatsangCategoryPopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SatsangCategoryPopupModel());
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: FFLocalizations.of(context).getText(
                      '10fxtvmq' /* Enter the Speaker Name */,
                    ),
                    hintStyle:
                        FlutterFlowTheme.of(context).labelMedium.override(
                              font: GoogleFonts.alegreyaSans(
