...
import 'dart:ui';
import '/index.dart';
import 'edit_gurudev_image_widget.dart' show EditGurudevImageWidget;
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class EditGurudevImageModel extends FlutterFlowModel<EditGurudevImageWidget> {
  ...
  bool isDataUploading_gurudevEditImage = false;
  FFUploadedFile uploadedLocalFile_gurudevEditImage =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_gurudevEditImage = '';
