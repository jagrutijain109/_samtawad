...
import 'dart:ui';
import '/index.dart';
import 'edit_knowledge_image_widget.dart' show EditKnowledgeImageWidget;
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class EditKnowledgeImageModel
    extends FlutterFlowModel<EditKnowledgeImageWidget> {
  ...
  bool isDataUploading_knowledgeImage = false;
  FFUploadedFile uploadedLocalFile_knowledgeImage =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_knowledgeImage = '';
