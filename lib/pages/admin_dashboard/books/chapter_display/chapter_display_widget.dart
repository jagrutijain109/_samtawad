...
class ChapterDisplayWidget extends StatefulWidget {
  ...
  static String routeName = 'chapter_display';
  static String routePath = '/chapterDisplay';

  @override
  State<ChapterDisplayWidget> createState() => _ChapterDisplayWidgetState();
}
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 20.0, 0.0, 0.0),
                              child: Text(
                                listViewChaptersRecord.cahpetrNumber,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.alegreyaSans(
                            ...
                            Padding(
                              ...
                              child: FlutterFlowAudioPlayer(
                                audio: Audio.network(
                                  listViewChaptersRecord.chapterAudio,
                                  metas: Metas(
                                    title: 'Title',
                                  ),
                                ),
