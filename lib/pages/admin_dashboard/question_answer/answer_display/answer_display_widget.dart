...
import 'answer_display_model.dart';
export 'answer_display_model.dart';
...
class AnswerDisplayWidget extends StatefulWidget {
  ...
  static String routeName = 'answer_display';
  static String routePath = '/answerDisplay';

  @override
  State<AnswerDisplayWidget> createState() => _AnswerDisplayWidgetState();
}

class _AnswerDisplayWidgetState extends State<AnswerDisplayWidget> {
  late AnswerDisplayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnswerDisplayModel());
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: StreamBuilder<List<AnswerRecord>>(
                    stream: queryAnswerRecord(
                      parent: widget!.questionref,
                    ),
                                ...
                                children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        valueOrDefault<String>(
                                          listViewAnswerRecord.createdTime
                                              ?.toString(),
                                          'created_time',
                                        ),
                                        maxLines: 3,
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                          EditAnswerWidget.routeName,
                                          queryParameters: {
                                            'answerquestion': serializeParam(
                                              listViewAnswerRecord,
                                              ParamType.Document,
                                            ),
                                          }.withoutNulls,
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        await listViewAnswerRecord.reference
                                            .delete();
                                      },
                                      child: Icon(
                                        Icons.delete,
