...
import 'dart:ui';
import '/index.dart';
import 'edit_satsang_shala_widget.dart' show EditSatsangShalaWidget;
...
class EditSatsangShalaModel extends FlutterFlowModel<EditSatsangShalaWidget> {
  ...
  String? _aashramNameTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'bley65cg' /* TextField is required */,
      );
    }
  ...
  bool isDataUploading_uploadSwatsangEditImage = false;
  FFUploadedFile uploadedLocalFile_uploadSwatsangEditImage =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadSwatsangEditImage = '';
