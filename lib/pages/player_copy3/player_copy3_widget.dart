...
import 'player_copy3_model.dart';
export 'player_copy3_model.dart';

class PlayerCopy3Widget extends StatefulWidget {
  const PlayerCopy3Widget({
    super.key,
    int? currentIndex,
    this.type,
    int? pos,
  ...
  static String routeName = 'PlayerCopy3';
  static String routePath = '/playerCopy3';

  @override
  State<PlayerCopy3Widget> createState() => _PlayerCopy3WidgetState();
}

class _PlayerCopy3WidgetState extends State<PlayerCopy3Widget> {
  late PlayerCopy3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerCopy3Model());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'vtzqtior' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '0qt0abcq' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'lf3aja2l' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'pvl765kr' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'iv50d367' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          height: 580.0,
                                          child:
                                              custom_widgets.AudioPlayerWidget(
                                            width: double.infinity,
                                            height: 580.0,
                                            audioRefs: containerAudioRecordList
                                                .map((e) => e.reference)
                                                .toList(),
