...
import 'player_copy2_copy_model.dart';
export 'player_copy2_copy_model.dart';

class PlayerCopy2CopyWidget extends StatefulWidget {
  const PlayerCopy2CopyWidget({
    super.key,
    this.id,
    this.type,
    int? pos,
  ...
  static String routeName = 'PlayerCopy2Copy';
  static String routePath = '/playerCopy2Copy';

  @override
  State<PlayerCopy2CopyWidget> createState() => _PlayerCopy2CopyWidgetState();
}

class _PlayerCopy2CopyWidgetState extends State<PlayerCopy2CopyWidget> {
  late PlayerCopy2CopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerCopy2CopyModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'iry6fda3' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'cdmsuunm' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'wyxwi784' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'kop7ihnn' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'joigqk27' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
