import 'package:samtawad_team/custom_code/actions/show_draggable_bottom_sheet.dart';

import '../../../custom_code/widgets/guruji_question_and_answer_page.dart';
...
import 'guruji_question_model.dart';
export 'guruji_question_model.dart';

class GurujiQuestionWidget extends StatefulWidget {
  const GurujiQuestionWidget({
    super.key,
  ...
  static String routeName = 'guruji_question';
  static String routePath = '/gurujiQuestion';

  @override
  State<GurujiQuestionWidget> createState() => _GurujiQuestionWidgetState();
}

class _GurujiQuestionWidgetState extends State<GurujiQuestionWidget> {
  late GurujiQuestionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GurujiQuestionModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: GurujiQuestionAndAnswerPage(
                          width: double.infinity,
                          // height: 900.0,
