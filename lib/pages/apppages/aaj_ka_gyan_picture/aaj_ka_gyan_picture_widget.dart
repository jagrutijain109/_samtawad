...
import 'aaj_ka_gyan_picture_model.dart';
export 'aaj_ka_gyan_picture_model.dart';

class AajKaGyanPictureWidget extends StatefulWidget {
  const AajKaGyanPictureWidget({
    super.key,
    this.aajkaKnowledge,
    this.currentIndex,
  });

  final List<AajKaKnowledgeRecord>? aajkaKnowledge;
  final int? currentIndex;

  static String routeName = 'aajKaGyanPicture';
  static String routePath = '/aajKaGyanPicture';

  @override
  State<AajKaGyanPictureWidget> createState() => _AajKaGyanPictureWidgetState();
}

class _AajKaGyanPictureWidgetState extends State<AajKaGyanPictureWidget> {
  late AajKaGyanPictureModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AajKaGyanPictureModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.intexNumber = widget!.currentIndex!;
      _model.maxIndex = functions.subtractOne(widget!.aajkaKnowledge!.length);
      safeSetState(() {});
    });
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '9tc6tlph' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'c1cl36eo' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'msi0s2fp' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'lki5hiof' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'xt7sxj6o' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
                                                            ...
                                                            StreamBuilder<
                                                              ...
                                                              builder: (context,
                                                                ...
                                                                return InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    if ((iconFavouriteRecord?.userId ==
                                                                            currentUserUid) &&
                                                                        (iconFavouriteRecord?.iteamId ==
                                                                            widget!.aajkaKnowledge
                                                                        ...
                                                                        () async {
                                                                          await FavouriteRecord
                                                                              ...
                                                                              .set(createFavouriteRecordData(
                                                                                image: widget!.aajkaKnowledge?.elementAtOrNull(_model.intexNumber)?.images,
                                                                                status: false,
                                                                                title: widget!.aajkaKnowledge?.elementAtOrNull(_model.intexNumber)?.tags,
                                                                                about: widget!.aajkaKnowledge?.elementAtOrNull(_model.intexNumber)?.information,
                                                                                imagelink: widget!.aajkaKnowledge?.elementAtOrNull(_model.intexNumber)?.imageUrl,
                                                                                userId: currentUserUid,
                                                                                type: 'aajkagyan',
                                                                                iteamId: widget!.aajkaKnowledge?.elementAtOrNull(_model.intexNumber)?.reference.id,
                                                                              ));
                                                                        }(),
                                                                      );
                                                                      await showDialog(
