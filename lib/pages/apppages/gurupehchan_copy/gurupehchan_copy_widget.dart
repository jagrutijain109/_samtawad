...
import 'gurupehchan_copy_model.dart';
export 'gurupehchan_copy_model.dart';

class GurupehchanCopyWidget extends StatefulWidget {
  const GurupehchanCopyWidget({super.key});

  static String routeName = 'GurupehchanCopy';
  static String routePath = '/gurupehchanCopy';

  @override
  State<GurupehchanCopyWidget> createState() => _GurupehchanCopyWidgetState();
}

class _GurupehchanCopyWidgetState extends State<GurupehchanCopyWidget> {
  late GurupehchanCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GurupehchanCopyModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '2fwo432w' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '4nwingbp' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'py9w6s1b' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '8l9mr3lg' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'j5510q99' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
