...
import 'satsang_model.dart';
export 'satsang_model.dart';

class SatsangWidget extends StatefulWidget {
  const SatsangWidget({
    super.key,
  ...
  static String routeName = 'satsang';
  static String routePath = '/satsang';

  @override
  State<SatsangWidget> createState() => _SatsangWidgetState();
}

class _SatsangWidgetState extends State<SatsangWidget> {
  late SatsangModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SatsangModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '8ztt4zr9' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'we5celhe' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '0rdj2a6d' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'j8ajrlej' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'r16prmdn' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          '0djs4xsk' /* Seach  Audio Using  Title / Si... */,
                                        ),
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<SatsangRecord>>(
                          stream: querySatsangRecord(
                            queryBuilder: (satsangRecord) => satsangRecord
                                .where(
                                  'category',
                                                              ...
                                                              builder:
                                                                ...
                                                                return GestureDetector(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        AudioInfoWidget(
                                                                      lyrics: listViewSatsangRecord
                                                                          .contactInfo,
                                                                      title: listViewSatsangRecord
                                                                          .title,
                                                                    ),
                                                                  ),
                                                                );
