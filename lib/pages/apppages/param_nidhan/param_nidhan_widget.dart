...
import 'param_nidhan_model.dart';
export 'param_nidhan_model.dart';

class ParamNidhanWidget extends StatefulWidget {
  const ParamNidhanWidget({super.key});

  static String routeName = 'paramNidhan';
  static String routePath = '/paramNidhan';

  @override
  State<ParamNidhanWidget> createState() => _ParamNidhanWidgetState();
}

class _ParamNidhanWidgetState extends State<ParamNidhanWidget> {
  late ParamNidhanModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParamNidhanModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '1pwd59us' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'mkuzsqwq' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'denxt7va' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'zj6yry11' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'ssfp7wz8' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: wrapWithModel(
                        model: _model.paramNidhanPageModel,
                        updateCallback: () => safeSetState(() {}),
                        child: ParamNidhanPageWidget(),
                      ),
                    ),
                  ),
                ),
