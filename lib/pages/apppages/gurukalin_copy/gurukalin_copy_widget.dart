...
import 'gurukalin_copy_model.dart';
export 'gurukalin_copy_model.dart';

class GurukalinCopyWidget extends StatefulWidget {
  const GurukalinCopyWidget({super.key});

  static String routeName = 'gurukalinCopy';
  static String routePath = '/gurukalinCopy';

  @override
  State<GurukalinCopyWidget> createState() => _GurukalinCopyWidgetState();
}

class _GurukalinCopyWidgetState extends State<GurukalinCopyWidget> {
  late GurukalinCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GurukalinCopyModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'ohds3lx7' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'fbdqksi8' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '9p6qo9iu' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'jc9coqmn' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '74exjttq' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'v476irl5' /* Seach  Audio Using  Title / Si... */,
                                        ),
                        ...
                        child: StreamBuilder<List<GurukalinSatsangRecord>>(
                          stream: queryGurukalinSatsangRecord(
                            queryBuilder: (gurukalinSatsangRecord) =>
                                gurukalinSatsangRecord.orderBy('created_time',
                                    descending: true),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
                                                              ...
                                                              builder:
                                                                ...
                                                                return GestureDetector(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                        AudioInfoWidget(
                                                                      lyrics: listViewGurukalinSatsangRecord
                                                                          .contactInfo,
                                                                      title: listViewGurukalinSatsangRecord
                                                                          .satsangTitle,
                                                                    ),
                                                                  ),
                                                                );
