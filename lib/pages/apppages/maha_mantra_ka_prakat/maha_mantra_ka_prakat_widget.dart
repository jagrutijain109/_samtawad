...
import 'maha_mantra_ka_prakat_model.dart';
export 'maha_mantra_ka_prakat_model.dart';

class MahaMantraKaPrakatWidget extends StatefulWidget {
  const MahaMantraKaPrakatWidget({super.key});

  static String routeName = 'maha_mantra_ka_prakat';
  static String routePath = '/mahaMantraKaPrakat';

  @override
  State<MahaMantraKaPrakatWidget> createState() =>
      _MahaMantraKaPrakatWidgetState();
}

class _MahaMantraKaPrakatWidgetState extends State<MahaMantraKaPrakatWidget> {
  late MahaMantraKaPrakatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MahaMantraKaPrakatModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'byxffd6d' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'ct4niku5' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'jcffiqy0' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'hbrzo5ij' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '6buu6fcy' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
