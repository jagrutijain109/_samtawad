...
class TestingWidget extends StatefulWidget {
  ...
  final List<GurijiJiImageRecord>? gurujiImage;
...
class _TestingWidgetState extends State<TestingWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.maxIndex = functions.subtractOne(widget!.gurujiImage!.length)!;
      safeSetState(() {});
    });
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '8sygtwwo' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'ukm35e66' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'eyu4ex3m' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '2uces7ov' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '4ipn2x7v' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
                                                                  ...
                                                                  onDoubleTap:
                                                                    ...
                                                                    if ((iconFavouriteRecord?.userId == currentUserUid) &&
                                                                        (iconFavouriteRecord?.type ==
                                                                            'gurupic') &&
                                                                        (widget!.gurujiImage?.elementAtOrNull(_model.intexNumber)?.reference.id ==
                                                                            iconFavouriteRecord?.guruDocRef?.id)) {
                                                                      unawaited(
                                                                        () async {
                                                                          await iconFavouriteRecord!
                                                                              .reference
                                                                              .delete();
                                                                        }(),
                                                                      );
                                                                        ...
                                                                        () async {
                                                                          await FavouriteRecord
                                                                              ...
                                                                              .set(createFavouriteRecordData(
                                                                                image: widget!.gurujiImage?.elementAtOrNull(_model.intexNumber)?.images,
                                                                                status: true,
                                                                                title: widget!.gurujiImage?.elementAtOrNull(_model.intexNumber)?.tags,
                                                                                about: widget!.gurujiImage?.elementAtOrNull(_model.intexNumber)?.information,
                                                                                imagelink: widget!.gurujiImage?.elementAtOrNull(_model.intexNumber)?.imageUrl,
                                                                                userId: currentUserUid,
                                                                                type: 'gurupic',
                                                                                indexNum: _model.intexNumber,
                                                                                guruDocRef: iconFavouriteRecord?.guruDocRef,
                                                                              ));
                                                                        }(),
                                                                      );
                                                                      await showDialog(
