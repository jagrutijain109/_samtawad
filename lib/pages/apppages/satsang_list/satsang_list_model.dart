...
import '/index.dart';
import 'satsang_list_widget.dart' show SatsangListWidget;
...
class SatsangListModel extends FlutterFlowModel<SatsangListWidget> {
  ...
  List<SatsangRecord> simpleSearchResults = [];
