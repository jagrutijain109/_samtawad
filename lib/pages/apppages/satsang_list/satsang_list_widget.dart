...
import 'satsang_list_model.dart';
export 'satsang_list_model.dart';

class SatsangListWidget extends StatefulWidget {
  const SatsangListWidget({
    super.key,
  ...
  static String routeName = 'satsang_list';
  static String routePath = '/satsangList';

  @override
  State<SatsangListWidget> createState() => _SatsangListWidgetState();
}

class _SatsangListWidgetState extends State<SatsangListWidget> {
  late SatsangListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SatsangListModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '1u02y5hu' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'q7tca59i' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '5jxx6rnm' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'uu5lqvlx' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'c6c1y2fn' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'wvxt2z44' /* Seach  Audio Using  Title / Si... */,
                                    ),
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Row(
                                ...
                                children: List.generate(
                                    rowSearchHistoryCollectionRecordList.length,
                                    (rowIndex) {
                                  final rowSearchHistoryCollectionRecord =
                                      rowSearchHistoryCollectionRecordList[
                                          rowIndex];
                                  return Text(
                                    rowSearchHistoryCollectionRecord.searchText,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          font: GoogleFonts.alegreyaSans(
                                                                  ...
                                                                  return GestureDetector(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          AudioInfoWidget(
                                                                        lyrics:
                                                                            listViewGurukalinSatsangRecord.contactInfo,
