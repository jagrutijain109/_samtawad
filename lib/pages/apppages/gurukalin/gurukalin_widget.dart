...
import 'gurukalin_model.dart';
export 'gurukalin_model.dart';

class GurukalinWidget extends StatefulWidget {
  const GurukalinWidget({
    super.key,
  ...
  static String routeName = 'gurukalin';
  static String routePath = '/gurukalin';

  @override
  State<GurukalinWidget> createState() => _GurukalinWidgetState();
}

class _GurukalinWidgetState extends State<GurukalinWidget> {
  late GurukalinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GurukalinModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'b4xbvz02' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'kp8q96p3' /* -- महात्मा मंगत राम जी महाराज */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '646vpcx9' /* वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '3gv6iwdl' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'b9i9pset' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          '4ykmel7t' /* Seach  Audio Using  Title / Si... */,
                                        ),
