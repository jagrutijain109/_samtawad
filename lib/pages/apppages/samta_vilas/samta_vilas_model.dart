...
import 'dart:ui';
import '/index.dart';
import 'samta_vilas_widget.dart' show SamtaVilasWidget;
...
class SamtaVilasModel extends FlutterFlowModel<SamtaVilasWidget> {
  ...
  List<QuestionRecord> simpleSearchResults = [];
  // State field(s) for ListView widget.

  PagingController<DocumentSnapshot?, QuestionRecord>?
  ...
  PagingController<DocumentSnapshot?, QuestionRecord> setListViewController2(
    Query query, {
  ...
  PagingController<DocumentSnapshot?, QuestionRecord>
    ...
    final controller =
        PagingController<DocumentSnapshot?, QuestionRecord>(firstPageKey: null);
    return controller
      ..addPageRequestListener(
        (nextPageMarker) => queryQuestionRecordPage(
