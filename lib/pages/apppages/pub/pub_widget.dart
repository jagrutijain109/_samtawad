...
import 'pub_model.dart';
export 'pub_model.dart';

class PubWidget extends StatefulWidget {
  const PubWidget({super.key});

  static String routeName = 'pub';
  static String routePath = '/pub';
...
class _PubWidgetState extends State<PubWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PubModel());
