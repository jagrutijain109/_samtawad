...
import 'guru_ji_ka_jivan_and_sadhna_model.dart';
export 'guru_ji_ka_jivan_and_sadhna_model.dart';

class GuruJiKaJivanAndSadhnaWidget extends StatefulWidget {
  const GuruJiKaJivanAndSadhnaWidget({super.key});

  static String routeName = 'guru_ji_ka_jivan_and_Sadhna';
  static String routePath = '/guruJiKaJivanAndSadhna';

  @override
  State<GuruJiKaJivanAndSadhnaWidget> createState() =>
      _GuruJiKaJivanAndSadhnaWidgetState();
}

class _GuruJiKaJivanAndSadhnaWidgetState
    extends State<GuruJiKaJivanAndSadhnaWidget> {
  late GuruJiKaJivanAndSadhnaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GuruJiKaJivanAndSadhnaModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'xis38f4z' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'q3vtnx7h' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '1cs7vq79' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '05lt5xg2' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'xmvpvk0q' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
