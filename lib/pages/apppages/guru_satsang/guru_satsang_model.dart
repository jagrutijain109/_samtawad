...
import '/index.dart';
import 'guru_satsang_widget.dart' show GuruSatsangWidget;
...
class GuruSatsangModel extends FlutterFlowModel<GuruSatsangWidget> {
  ...
  List<GurukalinSatsangRecord> simpleSearchResults = [];
