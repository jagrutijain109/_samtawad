    ...
    return GestureDetector(
      ...
      child: Scaffold(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'ik2vphlk' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'epysbx5o' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'g1owyixn' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'qcl8ildv' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'l2nb919k' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: [
              StreamBuilder<List<EpubBookRecord>>(
                stream: queryEpubBookRecord(
                  queryBuilder: (epubBookRecord) =>
                      epubBookRecord.orderBy('create_time', descending: true),
                ),
                builder: (context, snapshot) {
                  ...
                  List<EpubBookRecord> columnEpubBookRecordList =
                      snapshot.data!;
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: List.generate(columnEpubBookRecordList.length,
                          (columnIndex) {
                        final columnEpubBookRecord =
                            columnEpubBookRecordList[columnIndex];
                        return SingleChildScrollView(
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            mainAxisAlignment: MainAxisAlignment.center,
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            columnEpubBookRecord.epubBookImage,
                                            width: 115.3,
                                            height: 153.9,
                                            fit: BoxFit.cover,
                                          ),
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child:   Padding(
                                                        ...
                                                        child: Text(columnEpubBookRecord.autherName,
                                                          style: TextStyle(
                                                            fontSize: 16,
                                                            fontWeight: FontWeight.bold,
                                                          ),
                                                          // columnEpubBookRecord.autherName,
