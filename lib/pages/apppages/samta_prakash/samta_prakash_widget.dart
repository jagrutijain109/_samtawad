...
import 'samta_prakash_model.dart';
export 'samta_prakash_model.dart';

class SamtaPrakashWidget extends StatefulWidget {
  const SamtaPrakashWidget({super.key});

  static String routeName = 'samtaPrakash';
  static String routePath = '/samtaPrakash';

  @override
  State<SamtaPrakashWidget> createState() => _SamtaPrakashWidgetState();
}

class _SamtaPrakashWidgetState extends State<SamtaPrakashWidget> {
  late SamtaPrakashModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SamtaPrakashModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '51e5n1mc' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'qih5eyfx' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '05mqhmja' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'p9bnh80b' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'qrefrrca' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
