...
// import 'play_widget_model.dart';
// export 'play_widget_model.dart';
//
// class PlayWidgetWidget extends StatefulWidget {
//   const PlayWidgetWidget({
//     super.key,
//     this.audioList,
//   });
//
...
//
//   @override
//   State<PlayWidgetWidget> createState() => _PlayWidgetWidgetState();
// }
//
// class _PlayWidgetWidgetState extends State<PlayWidgetWidget> {
//   late PlayWidgetModel _model;
//
//   @override
...
//   void initState() {
//     super.initState();
//     _model = createModel(context, () => PlayWidgetModel());
//
...
//             stream: AudioRecord.getDocument(widget!.audioList!),
...
//                               onTap: () async {
//                                 await downloadFile(
//                                   filename: containerAudioRecord.audioTitle,
//                                   url: containerAudioRecord.audioUrl,
//                                 );
//                               },
//                               child: Icon(
...
//                                   final favoriteByUpdate = containerAudioRecord
//                                       .favoriteBy
...
//                                       [favoriteByElement]);
//                                   await containerAudioRecord.reference.update({
//                                     ...mapToFirestore(
//                                       {
...
//                                     ),
//                                   });
//                                   if (containerAudioRecord.favoriteBy
//                                       .contains(currentUserReference) ==
//                                       true) {
//                                     await containerAudioRecord.reference
//                                         .update({
//                                       ...mapToFirestore(
//                                         {
...
//
//                               },
//                               value: containerAudioRecord.favoriteBy
//                                   .contains(currentUserReference),
//                               onIcon: Icon(
//                                 Icons.favorite,
//                                 color: Color(0xFFC25123),
...
//                                         title: containerAudioRecord.audioTitle,
//                                         lyrics:
//                                             containerAudioRecord.audioLyrics,
//                                       ),
//                                     );
//                                   },
//                                 ).then((value) => safeSetState(() {}));
