...
import 'player_copy2_copy_copy_model.dart';
export 'player_copy2_copy_copy_model.dart';

class PlayerCopy2CopyCopyWidget extends StatefulWidget {
  const PlayerCopy2CopyCopyWidget({
    super.key,
    this.id,
    this.type,
    int? pos,
  ...
  static String routeName = 'PlayerCopy2CopyCopy';
  static String routePath = '/playerCopy2CopyCopy';

  @override
  State<PlayerCopy2CopyCopyWidget> createState() =>
      _PlayerCopy2CopyCopyWidgetState();
}

class _PlayerCopy2CopyCopyWidgetState extends State<PlayerCopy2CopyCopyWidget> {
  late PlayerCopy2CopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PlayerCopy2CopyCopyModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        FFLocalizations.of(context).getText(
                          '0hd5mntj' /* "प्रभु सत् आचरण और नि:चल बुद्ध... */,
                        ),
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'mf4prywp' /* आशीर्वाद ---- महात्मा मंगत राम... */,
                          ),
                          style:
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'f6g6z0xy' /*  वाणी ,सत्संग और ऑडियो बुक */,
                                ),
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '0cno9gai' /* गुरुदेव की तस्वीरें और फ़ोटो */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                                    ...
                                                    Align(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'kbwzgfub' /* ॐ ब्रह्म सत्यम सर्वाधार */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .titleSmall
